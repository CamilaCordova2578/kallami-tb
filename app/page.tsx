...
export default function Page() {
  ...
  return <main>
    ...
    <section id="historia" className="section timeline-section"><SectionHeading eyebrow="03 · Estructura narrativa" title="El camino del héroe" copy="Diez estaciones para observar cómo un sistema entra en crisis, aprende y recupera su equilibrio."/><div className="timeline">{timeline.map(([title, desc], i) => <div className="timeline-item" key={title}><div className="timeline-marker">{String(i + 1).padStart(2, '0')}</div><div><h3>{title}</h3><p>{desc}</p></div></div>)}</div></section>

   <section id="video" className="media-section"><div className="media-shell"><div className="media-top"><p className="eyebrow">04 · Pieza audiovisual</p><span>ARCHIVO / 01:55</span></div><div className="video-frame"><iframe src="https://www.youtube.com/embed/taV_quoWXjs" title="El Cerro Kallami y la Banda Devorada" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen /></div><div className="media-caption"><h2>La banda devorada</h2><div className="badges"><span>Duración: 01:55</span><span>Full HD</span><span>Estilo: 2D Pergamino Andino</span></div></div></div></section>
  ...
  <div className="scene-grid">
    ...
    <section id="flujo" className="section flow-section"><SectionHeading eyebrow="06 · Secuencia formal" title="Del conflicto al resultado" copy="Una lectura sistémica de la leyenda, expresada como flujo de información y decisiones."/><FlowDiagram /></section>
